    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct IPulpaStakingVault.Staking",
        "components": [
          {
            "name": "user",
            "type": "address",

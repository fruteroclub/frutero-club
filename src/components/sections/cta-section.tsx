      ...
      <div className="container mx-auto px-4">
        <div className="text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="bg-white text-frutero-dark hover:bg-white/90 px-8 py-4 text-lg font-bold rounded-full shadow-lg transform hover:scale-105 transition-all duration-200"
            >
              Unirme al Club 🎯
            </Button>

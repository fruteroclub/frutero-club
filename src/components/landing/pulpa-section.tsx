    ...
    <section className="page container w-full gap-y-6">
      ...
      <div className="mt-20 text-center">
        <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-frutero-orange to-frutero-pink p-8 text-white md:p-12">
          ...
          <button className="transform rounded-full bg-white px-8 py-4 font-bold text-frutero-dark shadow-lg transition-all duration-200 hover:scale-105 hover:bg-gray-100">
      ...
      {/* Info adicional */}
      <div className="mx-auto mt-16 max-w-4xl rounded-2xl bg-frutero-light/50 p-8">
        <div className="grid gap-6 text-center md:grid-cols-3">
          <div>
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-frutero-orange">
              <span className="text-2xl">🏆</span>
            </div>
            <h4 className="mb-2 font-bold text-frutero-dark">
              Rangos Exclusivos
            </h4>
          ...
          <div>
            ...
            <h4 className="mb-2 font-bold text-frutero-dark">Leaderboard</h4>
            <p className="text-sm text-frutero-dark/70">
